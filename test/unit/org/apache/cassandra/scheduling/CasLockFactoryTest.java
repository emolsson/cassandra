...
public class CasLockFactoryTest
{
    ...
    public static void defineSchema() throws ConfigurationException, UnknownHostException
    {
        ...
        SchemaLoader.createKeyspace(CasLockFactory.KEYSPACE_NAME, KeyspaceParams.simple(1),
                                    CasLockFactory.lockFactory,
                                    CasLockFactory.lock);
    ...
    @Test
    public void testLockAgain() throws LockException, IOException
    {
        try (DistributedLock lock = CasLockFactory.instance.tryLock("lock4", 1, new HashMap<>()))
        {
        }
    ...
    public void insertPriority(String resource, int priority)
    {
        ...
        String fmtQuery = String.format(query, CasLockFactory.KEYSPACE_NAME, CasLockFactory.LOCK_PRIORITY,
                                        resource,
                                        UUIDGen.getTimeUUID(),
                                        priority);
